...
#ifndef SWIMCRAFT_SWIFT_H
#define SWIMCRAFT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwimCraft",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSCoder;
SWIFT_CLASS("_TtC9SwimCraft13AddButtonCell")
@interface AddButtonCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Nullable addLabel;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC9SwimCraft11AppDelegate")
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC9SwimCraft13SceneDelegate")
...
@class NSIndexPath;
@class NSBundle;
SWIFT_CLASS("_TtC9SwimCraft29WorkoutCreationViewController")
@interface WorkoutCreationViewController : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate, UITableViewDataSource, UITableViewDelegate>
...
@property (nonatomic, weak) IBOutlet UIPickerView * _Nullable coachPicker;
@property (nonatomic, weak) IBOutlet UIButton * _Nullable saveButton;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9SwimCraft26WorkoutDetailTableViewCell")
@interface WorkoutDetailTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified yardsLabel;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified strokeLabel;
...
SWIFT_CLASS("_TtC9SwimCraft27WorkoutDetailViewController")
@interface WorkoutDetailViewController : UIViewController <UITableViewDataSource>
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified nameLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified coachLabel;
...
SWIFT_CLASS("_TtC9SwimCraft24WorkoutListTableViewCell")
